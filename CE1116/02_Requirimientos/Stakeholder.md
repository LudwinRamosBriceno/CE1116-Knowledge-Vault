...
-  Tienen interés directo en el resultado del proyecto.
-  Puede influir en el proyecto (decisiones).
-  Son quienes se ven afectados por el proyecto o producto (su trabajo, su dinero o experiencia).
-  También son aquellos que pueden afectar el proyecto en cuestión (Servicios, APIs).
